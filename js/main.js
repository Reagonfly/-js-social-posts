...
posts.forEach((element) => {
    //Bonus 1: Immissione della Data 
    const date = element.created;
    const [year, month, day] = date.split('-');
    const result = [month, day, year].join('/');
    //Bonus 2: Immissione delle Lettere nell'immagine di profilo
...
//Milestone 3 Bonus 3; Funzionamento del Tasto like
...
for (let i = 0; i < iLikes.length; i++){
    iLikes[i].addEventListener('click',function(e){
        ...
        //Controllo dei Like inseriti e rimozione del Like al click successivo
